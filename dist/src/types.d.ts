 ...
 */
export interface McpServer<TConfig extends Record<string, unknown> = Record<string, unknown>, TRoles extends string = never, TSession extends Record<string, unknown> = Record<string, unknown>> {
    getConfig(): TConfig;
 ...
 */
export type RoleGuard<TRoles extends string, TSession extends Record<string, unknown>, TConfig extends Record<string, unknown>> = (session: TSession, context: {
    config: TConfig;
    projectRoot?: string;
 ...
 */
export interface AuthConfig<TRoles extends string, TSession extends Record<string, unknown>, TConfig extends Record<string, unknown>> {
     ...
     * ```
     */
    loadSession: (token: string, context: {
        config: TConfig;
        projectRoot?: string;
    }) => Promise<TSession>;
}
 ...
 */
export interface McpServerOptions<TConfig extends Record<string, unknown> = Record<string, unknown>, TRoles extends string = never, TSession extends Record<string, unknown> = Record<string, unknown>> {
    name: string;
    version: string;
    description: string;
    id?: string;
 ...
 */
export type ToolHandler<TSchemaType extends TSchema, TConfig extends Record<string, unknown> = Record<string, unknown>, TSession extends Record<string, unknown> = Record<string, unknown>> = (params: Static<TSchemaType>, context: ToolContext<TConfig, TSession>) => Promise<ToolResult>;
/**
 * Tool configuration for object-based API
 */
export interface ToolConfig<TSchemaType extends TSchema, TConfig extends Record<string, unknown> = Record<string, unknown>, TRoles extends string = never, TSession extends Record<string, unknown> = Record<string, unknown>> {
 ...
 * @param context - Server context with access to configuration, project root, session and other data
 */
export type ResourceHandler<TConfig extends Record<string, unknown> = Record<string, unknown>, TSession extends Record<string, unknown> = Record<string, unknown>> = (uri: string, context: ResourceContext<TConfig, TSession>) => Promise<ResourceResult>;
/**
 * Resource configuration for object-based API
 */
export interface ResourceConfig<TConfig extends Record<string, unknown> = Record<string, unknown>, TRoles extends string = never, TSession extends Record<string, unknown> = Record<string, unknown>> {
    /** Resource URI */
    uri: string;
 ...
 * @param context - Server context with access to configuration, project root, session and other data
 */
export type PromptHandler<TSchemaType extends TSchema, TConfig extends Record<string, unknown> = Record<string, unknown>, TSession extends Record<string, unknown> = Record<string, unknown>> = (params: Static<TSchemaType>, context: PromptContext<TConfig, TSession>) => Promise<PromptResult>;
/**
 * Prompt configuration for object-based API
 */
export interface PromptConfig<TSchemaType extends TSchema, TConfig extends Record<string, unknown> = Record<string, unknown>, TRoles extends string = never, TSession extends Record<string, unknown> = Record<string, unknown>> {
 ...
 */
export interface ErrorHandlerContext<TConfig extends Record<string, unknown> = Record<string, unknown>, TSession extends Record<string, unknown> = Record<string, unknown>> {
 ...
 * ```
 */
export type ErrorHandler<TConfig extends Record<string, unknown> = Record<string, unknown>, TSession extends Record<string, unknown> = Record<string, unknown>> = (error: unknown, errorContext: ErrorHandlerContext<TConfig, TSession>) => string | Error;
